#!/bin/bash
mkdir -p src/pages/propiedad
cat > src/pages/propiedad/[id].astro << 'ASTROFILE'
---
...
git add .
git commit -m "feat: Add property detail page with images and contact form"
